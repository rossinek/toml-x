...
function showHelp() {
  console.log(`
Usage: tomlx <command> [flags] [...files]
...
Examples:
  ...
  tomlx merge base.toml overrides.toml > merged.toml
...
function commandMerge(args: string[]) {
  ...
  try {
    ...
    const output = flags.skipComment
      ? rawOutput
      : `# This file is autogenerated by: tomlx merge ${args.join(' ')}\n\n${rawOutput}`;
...
function main() {
  ...
  switch (command) {
    ...
    default:
      ...
      console.error('Run "tomlx --help" for usage information')
      process.exit(1)
  }
}
